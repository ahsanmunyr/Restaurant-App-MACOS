...
const ChangePassword = ({navigation, SignUpStepOne, Otp, userOtp,passwordChange,ForgotPasswordRedux}) => {
    ...
    useEffect(() => {
        console.log(ForgotPasswordRedux)
        if(ForgotPasswordRedux?.data){
            onChangeData(ForgotPasswordRedux.data)
        }
    },[ForgotPasswordRedux]);
    ...
    const onSubmit=()=>{
                        ...
                        if(password === confirmPassword){
                            console.log(password, "navigation", data.forget_password_hash, data.user_email)
                            passwordChange(password, navigation, data.forget_password_hash, data.user_email)
        ...
        <StatusBar translucent backgroundColor="transparent" />
            ...
            > 
                ...
                <ScrollView  style={styles.scrollView}>
                      <Image style={{width: '100%', height: 350, top: 0}} resizeMode='cover' source={require('./../../Assets/Images/header.png')}  />
                ...
                <View style={{flexDirection:'row',  height: 40,  left: 10}}>
                    ...
                    <View style={{ height:hp('10%'), alignItems:'center' ,flexDirection: 'row', marginTop: 10, width:'100%', justifyContent:'flex-end'}}>
...
const mapStatetoProps = ({ForgotPasswordRedux}) =>
{
      return {ForgotPasswordRedux}
}
