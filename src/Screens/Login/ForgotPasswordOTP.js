...
const ForgotPasswordOTP = ({navigation, SignUpStepOne, Otp, userOtp, verifyOtp,checkEmailOTP}) => {
...
export default connect(mapStatetoProps,actions)(ForgotPasswordOTP)
